                ...
                <div className=" mt-12 grid grid-cols-1 md:grid-cols-4 gap-8 lg:grid-cols-3">
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center gap-4">
                            <Key className="w-28 outline outline-2 outline-offset-4 outline-transparent group-hover:outline-lime-400 -all duration-500 group-hover:translate-y-1">
                                shift
                            </Key>
                            <Key className="w-28 outline outline-2 outline-offset-4  outline-transparent group-hover:outline-lime-400 -all duration-500 group-hover:translate-y-1 delay-150">
                                alt
                            </Key>
                            <Key className="w-28 outline outline-2 outline-offset-4  outline-transparent group-hover:outline-lime-400 -all duration-500 group-hover:translate-y-1 delay-300">
                                C
                            </Key>
                        </div>
                    </FeatureCard>
